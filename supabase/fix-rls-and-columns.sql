-- ============================================
-- LOCOMOTIVE — Fix RLS + Missing Columns
-- Run this in Supabase SQL Editor
-- ============================================

-- ===== FIX 1: Add missing columns to courses =====
-- (These are added by schema-payments.sql but may not have been run yet)
ALTER TABLE public.courses
    ADD COLUMN IF NOT EXISTS expiry_date date,
    ADD COLUMN IF NOT EXISTS is_installment boolean DEFAULT false;

-- ===== FIX 2: RLS policies for courses (admin write access) =====
-- Currently courses only have a public SELECT policy.
-- Admins need INSERT, UPDATE, DELETE.
...
-- ===== FIX 3: Same for modules and topics (needed for admin panel) =====
...
-- ===== FIX 4: Also make sure is_admin exists on profiles =====
ALTER TABLE public.profiles
    ADD COLUMN IF NOT EXISTS is_admin boolean DEFAULT false;

-- ===== FIX 5: Create the new payment tables (if not already done) =====
...
-- ===== GRANT YOUR ACCOUNT ADMIN PRIVILEGES =====
